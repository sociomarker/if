...
/*
  Class: SearchAndGoIconCollections
...
class SearchAndGoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new SearchAndGoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new SearchAndGoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new SearchAndGoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new SearchAndGoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new SearchAndGoSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('dripicons', new SearchAndGoDripicons('Dripicons', 'dripicon'));
        $this->addIconCollection('linear_icons', new SearchAndGoLinearIcons('Linear Icons', 'linear_icons'));
    }
    ...
    public function getIconCollectionIcons(iSearchAndGoIconCollection $collection) {
...
$search_and_go_elated_IconCollections = SearchAndGoIconCollections::get_instance();