...
<?php do_action('search_and_go_elated_before_header_top'); ?>

<div class="eltd-top-bar">
    <?php if($top_bar_in_grid) : ?>
    <div class="eltd-grid">
    <?php endif; ?>
		<?php do_action( 'search_and_go_elated_after_header_top_html_open' ); ?>
...
<?php do_action('search_and_go_elated_after_header_top'); ?>
