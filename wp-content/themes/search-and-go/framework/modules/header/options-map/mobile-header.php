...
if ( ! function_exists('search_and_go_elated_mobile_header_options_map') ) {

	function search_and_go_elated_mobile_header_options_map() {

		$panel_mobile_header = search_and_go_elated_add_admin_panel(array(
			'title' => 'Mobile header',
		...
		search_and_go_elated_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => search_and_go_elated_get_text_transform_array(true)
		));
		...
		search_and_go_elated_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => search_and_go_elated_get_font_style_array(true)
		));
		...
		search_and_go_elated_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => search_and_go_elated_get_font_weight_array(true)
		));
		...
		search_and_go_elated_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => search_and_go_elated_icon_collections()->getIconCollectionsExclude(array('linea_icons', 'simple_line_icons'))
		));
	...
	add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_mobile_header_options_map');
