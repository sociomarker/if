...
if ( ! function_exists('search_and_go_elated_logo_options_map') ) {

	function search_and_go_elated_logo_options_map() {
		...
		$panel_logo = search_and_go_elated_add_admin_panel(
			array(
				'page' => '_logo_page',
				'name' => 'panel_logo',
				'title' => 'Logo'
		...
		$hide_logo_container = search_and_go_elated_add_admin_container(
			array(
				'parent' => $panel_logo,
	...
	add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_logo_options_map', 6);
