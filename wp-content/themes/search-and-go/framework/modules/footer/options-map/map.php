...
if ( ! function_exists('search_and_go_elated_footer_options_map') ) {
	/**
	 * Add footer options
	 */
	function search_and_go_elated_footer_options_map() {
		...
		$footer_panel = search_and_go_elated_add_admin_panel(
			array(
				'title' => 'Footer',
				'name' => 'footer',
				'page' => '_footer_page'
		...
		$show_footer_top_container = search_and_go_elated_add_admin_container(
			array(
		...
		$show_footer_bottom_container = search_and_go_elated_add_admin_container(
			array(
	...
	add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_footer_options_map', 12);
