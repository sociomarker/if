<?php
namespace SearchAndGoElated\Modules\Shortcodes\VideoButton;
...
class VideoButton implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Elated Video Button', 'search-and-go'),
				'base' => $this->getBase(),
				'category' => 'by ELATED',
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/video-button-template', 'videobutton', '', $params);
