...
namespace SearchAndGoElated\Modules\Shortcodes\BlogList;
...
class BlogList implements ShortcodeInterface {
	...
	*/
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Elated Blog List', 'search-and-go'),
			'base' => $this->base,
			...
			'params' => array(
					array(
						...
						'holder' => 'div',
						'class' => '',
						'heading' => esc_html__('Type', 'search-and-go'),
						'param_name' => 'type',
						'value' => array(
							'Boxes' => 'boxes',
							'Masonry' => 'masonry',
	...
	public function render($atts, $content = null) {
		...
		$html ='';
        $html .= search_and_go_elated_get_shortcode_module_template_part('templates/blog-list-holder', 'blog-list', '', $params);
		return $html;
	...
	*/
	private function generateImageSize($params){
		...
		if ($imageSize !== '' && $imageSize == 'landscape') {
            $thumbImageSize .= 'search_and_go_elated_landscape';
        } else if($imageSize === 'square'){
			$thumbImageSize .= 'search_and_go_elated_square';
