<?php
namespace SearchAndGoElated\Modules\Shortcodes\IconWithText;

use SearchAndGoElated\Modules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package SearchAndGoElated\Modules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Elated Icon With Text', 'search-and-go'),
            'base'                      => $this->base,
    ...
    public function render($atts, $content = null) {
        ...
        return search_and_go_elated_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', $params['icon_position'], $params);
    }
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.search_and_go_elated_filter_px($params['text_left_padding']).'px';
        }

        if($params['icon_position'] == 'right' && !empty($params['text_right_padding'])) {
            $styles[] = 'padding-right: '.search_and_go_elated_filter_px($params['text_right_padding']).'px';
        }
