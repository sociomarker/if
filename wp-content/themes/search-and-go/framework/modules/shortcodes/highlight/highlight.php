<?php
namespace SearchAndGoElated\Modules\Shortcodes\Highlight;
...
class Highlight implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/highlight-template', 'highlight', '', $params);
