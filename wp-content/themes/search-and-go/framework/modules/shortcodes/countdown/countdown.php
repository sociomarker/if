<?php
namespace SearchAndGoElated\Modules\Shortcodes\Counter;
...
class Countdown implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Elated Countdown', 'search-and-go'),
			'base' => $this->getBase(),
			'category' => 'by ELATED',
			'admin_enqueue_css' => array(search_and_go_elated_get_skin_uri().'/assets/css/eltd-vc-extend.css'),
	...
	public function render($atts, $content = null)
	{
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/countdown-template', 'countdown', '', $params);
