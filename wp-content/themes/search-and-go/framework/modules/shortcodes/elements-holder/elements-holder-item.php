<?php
namespace SearchAndGoElated\Modules\Shortcodes\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => esc_html__('Elated Elements Holder Item', 'search-and-go'),
					'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
