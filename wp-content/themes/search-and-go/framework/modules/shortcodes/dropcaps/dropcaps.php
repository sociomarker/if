<?php
namespace SearchAndGoElated\Modules\Shortcodes\Dropcaps;
...
class Dropcaps implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
