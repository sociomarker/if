<?php
namespace SearchAndGoElated\Modules\Shortcodes\IconListItem;
...
class IconListItem implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Elated Icon List Item', 'search-and-go'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/icon-list-item-template', 'icon-list-item', '', $params);
		return $html;
	}
	 /**
	...
	private function getIconStyle($params){
		...
		if (!empty($params['icon_size'])) {
			$iconStylesArray[] = 'font-size:' .search_and_go_elated_filter_px( $params['icon_size']) . 'px';
		}
	...
	private function getTitleStyle($params){
		...
		if (!empty($params['title_size'])) {
			$titleStylesArray[] = 'font-size:' .search_and_go_elated_filter_px( $params['title_size']) . 'px';
		}
