<?php
namespace SearchAndGoElated\Modules\Shortcodes\Button;
 ...
 * @package SearchAndGoElated\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Elated Button', 'search-and-go'),
            'base'                      => $this->base,
            'category'                  => 'by ELATED',
            ...
            'params'                    => array_merge(
                ...
                array(
                    ...
                    array(
                        ...
                        'value'       => search_and_go_elated_get_font_weight_array(true),
                        'admin_label' => true,
                        'group'       => 'Design Options',
                        'save_always' => true
                    ),
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'search-and-go'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    )
                )
    ...
    public function render($atts, $content = null) {
        ...
        return search_and_go_elated_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.search_and_go_elated_filter_px($params['font_size']).'px';
        }
