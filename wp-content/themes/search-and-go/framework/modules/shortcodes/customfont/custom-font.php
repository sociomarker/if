<?php
namespace SearchAndGoElated\Modules\Shortcodes\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Elated Custom Font', 'search-and-go'),
				'base' => $this->getBase(),
				'category' => 'by ELATED',
				...
				'params' => array(
					...
					array(
						...
						"value" => search_and_go_elated_get_font_style_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						...
						"value" => search_and_go_elated_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => search_and_go_elated_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
