<?php
namespace SearchAndGoElated\Modules\Shortcodes\Blockquote;
...
class Blockquote implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Elated Blockquote', 'search-and-go'),
				'base' => $this->getBase(),
				'category' => 'by ELATED',
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/blockquote-template', 'blockquote', '', $params);
