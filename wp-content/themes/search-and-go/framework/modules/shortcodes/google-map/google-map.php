<?php
namespace SearchAndGoElated\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Elated Google Map', 'search-and-go'),
				'base' => $this->base,
				'category' => 'by ELATED',
	...
	public function render($atts, $content = null) {
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
