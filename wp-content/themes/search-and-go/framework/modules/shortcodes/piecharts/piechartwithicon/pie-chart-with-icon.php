<?php
namespace SearchAndGoElated\Modules\Shortcodes\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Elated Pie Chart With Icon', 'search-and-go'),
			'base' => $this->getBase(),
			...
			'params' => array_merge(
				...
				search_and_go_elated_icon_collections()->getVCParamsArray(),
				array(
					array(
						'type' => 'colorpicker',
						'heading' => 'Icon Color',
						'param_name' => 'icon_color',
						'dependency' => Array('element' => 'icon_pack', 'value' => search_and_go_elated_icon_collections()->getIconCollectionsKeys()),
						'group' => 'Design Options',
					),
					array(
						'type' => 'textfield',
	...
	public function render($atts, $content = null)
	{
		...
		$html = search_and_go_elated_get_shortcode_module_template_part('templates/pie-chart-with-icon', 'piecharts/piechartwithicon', '', $params);
	...
	private function getPieChartIcon($params) {
		...
		$pie_chart_icon = search_and_go_elated_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );
