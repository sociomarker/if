<?php
	...
	$author_info_box = esc_attr(search_and_go_elated_options()->getOptionValue('blog_author_info'));
	$author_info_email = esc_attr(search_and_go_elated_options()->getOptionValue('blog_author_info_email'));
	$social_networks = search_and_go_elated_get_user_custom_fields($author_id);
	...
	<div class="eltd-author-description">
		...
		<div class="eltd-author-description-inner">
			...
			<div class="eltd-author-description-image">
				<?php echo search_and_go_elated_kses_img(get_avatar(get_the_author_meta( 'ID' ), 100)); ?>
			</div>
