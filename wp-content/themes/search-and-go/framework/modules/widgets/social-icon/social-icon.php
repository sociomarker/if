 ...
 */
class SearchAndGoSocialIconWidget extends SearchAndGoWidget {
    /**
    ...
    protected function setParams() {
        $this->params = array_merge(
            search_and_go_elated_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => 'Link',
    ...
    public function widget($args, $instance) {
        ...
        <a class="eltd-social-icon-widget-holder" <?php echo search_and_go_elated_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php search_and_go_elated_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
