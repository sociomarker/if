 ...
 *
 * Class SearchAndGoWidget
 */
abstract class SearchAndGoWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'search-and-go'); ?></p>
        <?php }
    }
...
$search_and_go_elated_Framework = SearchAndGoFramework::get_instance();
$eltdSkinManager = new SearchAndGoSkinManager();
$search_and_go_elated_Framework->setSkin($eltdSkinManager->getSkin());
