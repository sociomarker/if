...
if(!function_exists('search_and_go_elated_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function search_and_go_elated_get_wpml_pages_for_current_page() {
...
if(!function_exists('search_and_go_elated_disable_wpml_css')) {
    function search_and_go_elated_disable_wpml_css() {
	    define('ICL_DONT_LOAD_LANGUAGE_SELECTOR_CSS', true);
    }

	add_action('after_setup_theme', 'search_and_go_elated_disable_wpml_css');
}