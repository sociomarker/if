...
if ( ! function_exists('search_and_go_elated_title_options_map') ) {

	function search_and_go_elated_title_options_map() {
		...
		$panel_title = search_and_go_elated_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
		...
		$show_title_area_container = search_and_go_elated_add_admin_container(
			array(
				'parent' => $panel_title,
		...
		$title_area_type_container = search_and_go_elated_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		search_and_go_elated_add_admin_field(
			array(
				'name' => 'title_area_show_title_text',
				'type' => 'yesno',
				'default_value' => 'no',
				'label' => 'Show Title Text',
				'description' => 'This option will display Title text in Title Area',
				'parent' => $title_area_type_container,
			)
		);
		...
		$title_area_background_image_responsive_container = search_and_go_elated_add_admin_container(
			array(
				'parent' => $show_title_area_container,
		...
		$panel_typography = search_and_go_elated_add_admin_panel(
			array(
				'page' => '_title_page',
		...
		$group_page_title_styles = search_and_go_elated_add_admin_group(array(
		...
		$row_page_title_styles_1 = search_and_go_elated_add_admin_row(array(
		...
		$row_page_title_styles_2 = search_and_go_elated_add_admin_row(array(
		...
		$group_page_subtitle_styles = search_and_go_elated_add_admin_group(array(
		...
		$row_page_subtitle_styles_1 = search_and_go_elated_add_admin_row(array(
		...
		$row_page_subtitle_styles_2 = search_and_go_elated_add_admin_row(array(
		...
		$group_page_breadcrumbs_styles = search_and_go_elated_add_admin_group(array(
		...
		$row_page_breadcrumbs_styles_1 = search_and_go_elated_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_2 = search_and_go_elated_add_admin_row(array(
		...
		$row_page_breadcrumbs_styles_3 = search_and_go_elated_add_admin_row(array(
	...
	add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_title_options_map', 8);
