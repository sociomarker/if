...
$video_post_format_meta_box = search_and_go_elated_add_meta_box(
	array(
		'scope' =>	array('post'),
...
$eltd_video_embedded_container = search_and_go_elated_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
...
$eltd_video_self_hosted_container = search_and_go_elated_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
