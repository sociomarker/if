...
$title_meta_box = search_and_go_elated_add_meta_box(
    array(
        'scope' => array('page', 'portfolio-item', 'post', 'listing-item'),
        'title' => 'Title',
        'name' => 'title_meta'
    )
);
    ...
    $show_title_area_meta_container = search_and_go_elated_add_admin_container(
        array(
            'parent' => $title_meta_box,
        ...
        $title_area_type_meta_container = search_and_go_elated_add_admin_container(
            array(
                'parent' => $show_title_area_meta_container,
		...
		search_and_go_elated_add_meta_box_field(
            array(
                'name' => 'eltd_title_area_show_title_text_meta',
                'type' => 'select',
                'default_value' => '',
        ...
        $hide_background_image_meta_container = search_and_go_elated_add_admin_container(
            array(
                'parent' => $show_title_area_meta_container,
        ...
        $title_area_background_image_responsive_meta_container = search_and_go_elated_add_admin_container(
            array(
                'parent' => $hide_background_image_meta_container,
