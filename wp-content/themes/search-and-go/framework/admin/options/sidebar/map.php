...
if ( ! function_exists('search_and_go_elated_sidebar_options_map') ) {

	function search_and_go_elated_sidebar_options_map() {
		...
		$panel_widgets = search_and_go_elated_add_admin_panel(
			array(
				'page'  => '_sidebar_page',
				'name'  => 'panel_widgets',
				'title' => 'Widgets'
		...
		$group_sidebar_padding = search_and_go_elated_add_admin_group(array(
			'name'		=> 'group_sidebar_padding',
			'title'		=> 'Padding',
			'parent'	=> $panel_widgets
		));

		$row_sidebar_padding = search_and_go_elated_add_admin_row(array(
	...
	add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_sidebar_options_map', 11);
