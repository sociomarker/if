...
if ( ! function_exists('search_and_go_elated_general_options_map') ) {
    /**
     * General options page
     */
    function search_and_go_elated_general_options_map() {
        ...
        $panel_design_style = search_and_go_elated_add_admin_panel(
            array(
                'page'  => '',
        ...
        $additional_google_fonts_container = search_and_go_elated_add_admin_container(
            array(
                'parent'            => $panel_design_style,
        ...
        $boxed_container = search_and_go_elated_add_admin_container(
            array(
                'parent'            => $panel_design_style,
        ...
        search_and_go_elated_add_admin_field(
            array(
                ...
                'args'          => array(
                    "dependence" => true,
                    "dependence_hide_on_yes" => "",
                    "dependence_show_on_yes" => "#eltd_overlapping_content_container"
                )
            )
        );

        $overlapping_content_container = search_and_go_elated_add_admin_container(
            array(
                'parent'            => $panel_design_style,
                'name'              => 'overlapping_content_container',
                'hidden_property'   => 'overlapping_content',
                'hidden_value'      => 'no'
            )
        );
        ...
        search_and_go_elated_add_admin_field(
            array(
                'name'          => 'overlapping_content_padding',
                'type'          => 'text',
                'default_value' => '',
                'label'         => 'Overlapping Content Padding',
                'description'   => '',
                'parent'        => $overlapping_content_container,
                'args' => array(
                    'col_width' => 3
                )
            )
        ...
        $panel_settings = search_and_go_elated_add_admin_panel(
            array(
                'page'  => '',
                'name'  => 'panel_settings',
                'title' => 'Settings'
        ...
        $page_transitions_container = search_and_go_elated_add_admin_container(
            array(
                'parent'            => $panel_settings,
        ...
        $group_pt_spinner_animation = search_and_go_elated_add_admin_group(array(
        ...
        $row_pt_spinner_animation = search_and_go_elated_add_admin_row(array(
        ...
        $true_ajax_params_container = search_and_go_elated_add_admin_container(
            array(
                'parent'            => $page_transitions_container,
        ...
        $panel_custom_code = search_and_go_elated_add_admin_panel(
            array(
                'page'  => '',
    ...
    add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_general_options_map', 5);
