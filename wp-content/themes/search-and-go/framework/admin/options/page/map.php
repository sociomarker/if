...
if ( ! function_exists('search_and_go_elated_page_options_map') ) {

    function search_and_go_elated_page_options_map() {
        ...
        $panel_sidebar = search_and_go_elated_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_sidebar',
                'title' => 'Design Style'
    ...
    add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_page_options_map',9);
