...
if ( ! function_exists('search_and_go_elated_content_bottom_options_map') ) {

	function search_and_go_elated_content_bottom_options_map() {
		...
		$panel_content_bottom = search_and_go_elated_add_admin_panel(
			array(
		...
		$enable_content_bottom_area_container = search_and_go_elated_add_admin_container(
			array(
				'parent'            => $panel_content_bottom,
	...
	add_action( 'search_and_go_elated_options_map', 'search_and_go_elated_content_bottom_options_map', 10);
