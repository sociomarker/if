<?php if ( $items ) { //If user has items in package

	$max_items_in_package = get_post_meta( $package->ID, 'eltd_listing_package_count', true );
	$current_in_package   = $items->post_count;
	$remaining_items      = (int) $max_items_in_package - $current_in_package;
	$expiry_date          = new DateTime( $expiry_date );
	$expiry_date          = $expiry_date->format( 'j F Y' );
	...
	?>
	<div class = "eltd-user-package-info-section">

		<div class="eltd-user-package-top-section clearfix">
			<div class="eltd-user-package-top-section-part">
			<span>
				<?php echo esc_attr($package->post_title); ?>
			</span>
			</div>
			<div class="eltd-user-package-top-section-part">
			<span>
				<?php
				esc_html_e( 'Items Remaining: ', 'eltd_listing' );
			...
			<span>
				<?php
				esc_html_e( 'Expiry date: ', 'eltd_listing' );
				echo $expiry_date;
				?>
			</span>
			</div>
		...
		<ul class="eltd-listing-package-list">
			...
			<li class="eltd-listing-package-list-item clearfix">
				...
				<div class="eltd-listing-package-list-part clearfix">
					<a class="eltd-view-listing eltd-listing-item-inner-part" href="<?php the_permalink(); ?>">
					...
					<a class="eltd-delete-listing eltd-listing-item-inner-part" href="" data-listing-id= <?php echo esc_attr( get_the_ID() ) ?>>
						<span class="eltd-listing-user-action-icon">
							<?php
							if ( eltd_listing_theme_installed() ) {
